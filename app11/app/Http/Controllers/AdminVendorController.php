<?php namespace App\Http\Controllers;
	...
	class AdminVendorController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Produk','name'=>'produk','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'hardware;software'];
			...
			//$this->form[] = ["label"=>"Produk","name"=>"produk","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
