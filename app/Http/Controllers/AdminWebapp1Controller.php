<?php namespace App\Http\Controllers;
	...
	class AdminWebapp1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Nama Panjang","name"=>"nama_panjang"];
			...
			$this->form[] = ['label'=>'Nama Panjang','name'=>'nama_panjang','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Nama Panjang","name"=>"nama_panjang","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
